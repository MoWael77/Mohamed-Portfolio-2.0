  ...
  return (
    <div className="min-h-screen bg-black text-green-400 font-mono">
      ...
      <div className="flex flex-col lg:flex-row h-[calc(100vh-180px)]">
        ...
        <div className="lg:w-1/3 p-4 sm:p-8 flex items-center justify-center border-r border-green-800 relative pt-24 lg:pt-16">
          <div className="relative" style={{ top: '1rem' }}>
            {/* Realistic Lanyard System */}
            <div 
              className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-20 lg:-translate-y-24 transition-transform duration-200 ease-out"
              style={{
                transform: `translateX(-50%) translateY(-5rem) rotate(${lanyardRotation}deg)`,
                transformOrigin: 'center top',
                WebkitTransform: `translateX(-50%) translateY(-5rem) rotate(${lanyardRotation}deg)`,
                WebkitTransformOrigin: 'center top'
              }}
            >
              {/* Main lanyard strap */}
              <div className="w-4 h-20 bg-gradient-to-b from-gray-600 via-gray-700 to-gray-800 rounded-sm shadow-xl relative overflow-hidden">
                {/* Fabric texture */}
                <div className="absolute inset-0 opacity-30">
                  <div className="w-full h-px bg-gray-500 mt-2"></div>
                  <div className="w-full h-px bg-gray-500 mt-3"></div>
                  <div className="w-full h-px bg-gray-500 mt-3"></div>
                </div>
                {/* Stitching detail */}
              ...
              <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 w-6 h-5 bg-gradient-to-b from-gray-400 to-gray-600 rounded-sm shadow-lg border border-gray-500">
                {/* Clip mechanism */}
                <div className="absolute top-1 left-1/2 transform -translate-x-1/2 w-2 h-1.5 bg-gray-800 rounded-sm"></div>
                <div className="absolute bottom-1 left-1/2 transform -translate-x-1/2 w-3 h-1 bg-gray-300 rounded-full"></div>
                {/* Metal shine */}
                <div className="absolute top-0 left-0 w-1.5 h-1.5 bg-white opacity-30 rounded-full blur-sm"></div>
              </div>
              
              {/* Connection point to card */}
              <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-1 h-1.5 bg-gray-600"></div>
            </div>
            ...
            >
              <div className="w-7 h-7 bg-gradient-to-br from-gray-300 to-gray-500 rounded-full shadow-lg border-2 border-gray-400">
                <div className="absolute inset-1 bg-gradient-to-br from-gray-200 to-gray-400 rounded-full">
                  <div className="absolute top-1 left-1 w-1.5 h-1.5 bg-white opacity-50 rounded-full blur-sm"></div>
                </div>
              </div>
            </div>

            <div
              className="card-container relative cursor-pointer mt-2"
